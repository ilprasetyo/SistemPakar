<div class="main-menu-content">
            <ul class="navigation navigation-main" id="sidebar" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a href="<?= base_url()?>admin/gejala"><i class="feather icon-chevrons-right"></i><span class="menu-title" data-i18n="">Data Gejala</span></a>
                </li>
                <li class="nav-item"><a href="<?= base_url()?>admin/penyakit"><i class="feather icon-chevrons-right"></i><span class="menu-title" data-i18n="">Data Penyakit</span></a>
                </li>
                <li class="nav-item"><a href="<?= base_url()?>admin/perawatan"><i class="feather icon-chevrons-right"></i><span class="menu-title" data-i18n="">Perawatan</span></a>
                </li>
                <li class="nav-item"><a href="<?= base_url()?>admin/informasi"><i class="feather icon-info"></i><span class="menu-title" data-i18n="">Informasi</span></a>
                </li>
